...
import { PersonGroupRepository } from 'src/repositories/person-group.repository';
...
export type ServiceOverrides = {
  ...
  personGroup: PersonGroupRepository;
...
export const getMocks = () => {
  ...
  const mocks: ServiceMocks = {
    ...
    personGroup: automock(PersonGroupRepository, { strict: false }),
...
export const newTestService = <T extends BaseService>(
  ...
  const sut = new Service(
    ...
    overrides.personGroup || (mocks.personGroup as As<PersonGroupRepository>),
